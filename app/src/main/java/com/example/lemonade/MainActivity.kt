...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when(lemonadeState){
           ...
           SELECT -> {
               submitText = getResources().getString(R.string.lemon_select)
               textAction.setText(submitText)

               lemonImage!!.setImageResource(R.drawable.lemon_tree)}
            // SQUEEZE represents the "squeeze lemon" state
           SQUEEZE -> {
               submitText = getResources().getString(R.string.lemon_squeeze)
               textAction.setText(submitText)
                lemonImage!!.setImageResource(R.drawable.lemon_squeeze)
           }
            // DRINK represents the "drink lemonade" state
            DRINK -> {
                submitText = getResources().getString(R.string.lemon_drink)
                textAction.setText(submitText)
                    lemonImage!!.setImageResource(R.drawable.lemon_drink)
            }
            // RESTART represents the state where the lemonade has been drunk and the glass is empty
            else -> {
                submitText = getResources().getString(R.string.lemon_empty_glass)
                textAction.setText(submitText)
